...
<div id="itemEditWindow" class="easyui-window" title="恢复用户" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/uspfhist-edit'" style="width:80%;height:80%;padding:10px;">
</div>
<script>
