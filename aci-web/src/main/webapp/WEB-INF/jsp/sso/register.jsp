    ...
    <div class="mc">
        <form id="personRegForm" method="post" onsubmit="return false;">
            <div class="form" onselectstart="return false;">
                ...
                <div class="item" id="select-regName">
                    <span class="label"><b class="ftx04">*</b>报告者：</span>

                    <div class="fl item-ifo">
                        <div class="o-intelligent-regName">
                            <input type="text" id="regReporter" name="reporterid" class="text" tabindex="1" autoComplete="off"
                                   onpaste="return false;"
                                   value=""
                                   onfocus="if(this.value=='') this.value='';this.style.color='#333'"
                                   onblur="if(this.value=='') {this.value='';this.style.color='#999999'}"/>
                ...
                <div id="o-password">
                    <div class="item">
                        ...
                        <div class="fl item-ifo">
                            <input type="password" id="pwd" name="uscr.password" class="text" tabindex="2"
                    ...
                    <div class="item">
                        ...
                        <div class="fl item-ifo">
                            <input type="password" id="pwdRepeat" name="uscr.pwdRepeat" class="text" tabindex="3"
                                   onpaste="return  false" autocomplete="off"/>
                            <i class="i-pass"></i>
					...
					<div class="item" id="dphone">
						...
						<div class="fl item-ifo">
							<input type="text" id="telno" maxlength="11" name="telno"
								class="text" tabindex="4"
								autocomplete="off" /> <i class="i-telno"></i> <label
								id="phone_succeed" class="blank"></label> <label
								id="phone_error"></label>
						</div>
					</div>
					<div class="item" id="demail">
						<span class="label"><b class="ftx04">*</b>邮箱地址：</span>
                ...
                <div class="item">
                    <span class="label">&nbsp;</span>
                    <input type="button"  id="registsubmit" value="立即注册" tabindex="8"
				...
				$.ajax({
	            	...
	            	success : function(data) {
	            		if (data.data) {//taotaoresult.data :true |false
	            			//检查手机号是否存在
	            			$.ajax({
	            				url : REGISTER.param.surl + "/user/check/"+$("#telno").val()+"/2?r=" + Math.random(),
